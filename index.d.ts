 ...
 * ```
 */
export declare class PluginCheckHardwareOriginal extends AwesomeCordovaNativePlugin {
    /**
...
export declare const PluginCheckHardware: PluginCheckHardwareOriginal;